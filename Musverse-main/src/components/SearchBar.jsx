...
const SearchBar = () => {
  ...
  return (
    <section className="flex items-center searchBarContainer gap-4 w-1/2 max-md:w-full md:w-full">
      ...
      <div
        className="flex  items-center w-full focus-within:border-darkTextColor group transition-all duration-400 ease-linear rounded-lg pl-5 pr-1 h-12 bg-[#563c59] border-[#ffd4d46e]"
