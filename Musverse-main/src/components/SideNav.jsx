...
const SideNav = () => {
  ...
  return (
    <div className={"float-left w-52 h-[26rem] max-md:w-0 select-none"}>
      <div
        className={
          "bg-[#460761] border-r-2 border-solid border-gray-700 text-darkTextColor top-0  w-52 transition-all duration-200 ease-linear  fixed z-50 h-full  py-10 " +
        ...
        <section className="px-7 max-md:px-10 ">
          ...
          <section className="mt-6">
            ...
            <ul className="flex flex-col gap-6 mt-5">
              ...
              {loggedIn ? (
                <div
                className="bg-purple-900 cursor-pointer text-white p-3  gap-2  text-lg  rounded-full drop-shadow-2xl hover:translate-x-2 duration-150 transition-all "
                onClick={HandleSideNav}
              >
               ...
               <img src={data?.profile} alt="user-profile" className="w-12 lg:w-8 rounded-full" />
                ...
                onClick={HandleSideNav}
                to={"/login"}
                className="bg-purple-500 text-white p-3 flex gap-2  text-lg items-center rounded-lg justify-center"
              >
                <LockOpenIcon />
                Login
              </Link>
