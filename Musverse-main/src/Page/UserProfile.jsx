...
const UserProfile = () => {
  ...
  return (
    <div className='p-4 md:p-6 lg:p-8 flex justify-center items-center bg-[#371645] h-screen'>

      {profileData && <SuccessNotify message={"Profile updated"} />}
      {error && <ErrorNotify message={"Error updating profile"} />}
      <div className="max-w-sm rounded-2xl text-[#501259] lg:backdrop-blur-lg  p-8 md:p-10 lg:p-10 bg-gradient-to-b from-white/60 to-white/30 border-[1px] border-solid border-white border-opacity-30 shadow-black/70 shadow-2xl -translate-y-10 relative" ref={modelRef}>
        ...
        <h1 className='font-bold text-gray text-xl mb-4 mt-7 text-center'>Vanakkam,{username}</h1>
